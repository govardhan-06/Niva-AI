...
Functions:
    - generate_email_otp: Generate a 4 digit OTP and store it in the database.
...
from niva_app.models.verification import EmailVerificationOTP
...
def generate_email_otp(email: str):
    """
    Generate a 4 digit OTP and store it in the database.
